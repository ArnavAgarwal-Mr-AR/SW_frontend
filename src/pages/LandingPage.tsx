        ...
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 lg:pr-10 mb-12 lg:mb-0">
            ...
            <div className={`flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'} transition-all duration-700 delay-200`}>
              <a href="/register" className="px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-700 text-white rounded-full font-medium hover:shadow-xl transition transform hover:-translate-y-1 active:translate-y-0 flex items-center justify-center">
                <span>Sign Up</span>
